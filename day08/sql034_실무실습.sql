...
-- 샘플문제 : 사원정보 테이블, 사번, 이름, 급여, 입사일, 상사의 사원번호를 출력하시오.
SELECT employee_id
...
/* 1. 사원정보 사원의 성과 이름을 name으로, 업무는 job, 급여는 salary,
  연봉의 $100 보너스를 추가 계산한 연봉은 Increased Ann Salary,
...
/* 2. 사원 정보 모든 사원의 Last name에 Last name: 1 Year Salary = $연봉
...
SELECT FIRST_NAME + ' ' + LAST_NAME AS 'name'
 ...
 /* 4. lastname에 e와 o 글자가 포함된 사원을 출력하시오. (10개행) */
